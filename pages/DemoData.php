...
<head>
    ...
    <style>
        ...
        .wrap label, .wrap input,.wrap span,.wrap button  {
            margin:5px;
        }
        #custom-wrap input{
...
<body>
    ...
    <form method="post">
        <div id="wrap1" class="wrap">
            ...
            value="reset">Reset</button><span>Reset All Data To Demo Data</span><br/>
        </div>
        <div id="wrap2" class="wrap">
        <button type="submit" name="empty"
            value="empty">Empty</button><span>Empty All Data </span><br/>
        </div>
