...
<form class="custompad" id="4jf_table" action="FilterSearching.php" method="GET">
    ...
    <!-- submit buttons -->
    <br>
    <button type=submit name="submit" onclick="document.getElementById('4jf_table').classList.add('mkhidden');">Submit</button>
...
<?php
    ...
    if ($result->num_rows > 0) {
        echo "<table id='3jf_table' class='result_table' BORDER>";
