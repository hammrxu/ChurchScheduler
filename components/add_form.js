// modules
let b = "<form action='../controller/var_act' target='dummyframe' method='POST' class='add-form' display='block'><legend>Add New var_name</legend></br><group><lable>Name</lable><input name='var_inp' id='var_inp' required></input><input type='hidden' id=idvalue name='idvalue' value=''></input></group>";
