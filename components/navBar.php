...
<div class="navbar-bg">
    <div class="navbar-wrap">
        ...
        if (isset($_SESSION['username'])) {
            echo '<div id="nav-login" class="nav-log"><a href="../pages/login/profile.php" style="color:white;cursor:pointer;" id="nav-login-a">Hi, ' . $_SESSION['username'] . '</a>&nbsp;<a href=../pages/logout/logout.php style="color:white;cursor:pointer;">
        Log Out</a></div>';
        } else {
